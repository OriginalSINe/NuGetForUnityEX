...
namespace NugetForUnity
{
  ...
  /// </summary>
  public class ConfigFilePackages
  {
    /// <summary>
    ...
    /// </summary>
    /// <returns>A newly created <see cref="ConfigFilePackages"/>.</returns>
    public static ConfigFilePackages Load(string filepath)
    {
      ConfigFilePackages configFile = new ConfigFilePackages();
